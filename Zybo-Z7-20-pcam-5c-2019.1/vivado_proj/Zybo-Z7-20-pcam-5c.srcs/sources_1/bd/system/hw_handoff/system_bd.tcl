...
# module references:
# DVIClocking, gauss, grayscale2rgb, rgb2grayscale, sobel
...
proc create_root_design { parentCell } {
  ...
  set block_name gauss
  set block_cell_name gauss_0
  if { [catch {set gauss_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gauss_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: grayscale2rgb_0, and set properties
  set block_name grayscale2rgb
  set block_cell_name grayscale2rgb_0
  if { [catch {set grayscale2rgb_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $grayscale2rgb_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: rgb2grayscale_0, and set properties
  set block_name rgb2grayscale
  set block_cell_name rgb2grayscale_0
  if { [catch {set rgb2grayscale_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rgb2grayscale_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set block_name sobel
  set block_cell_name sobel_0
  if { [catch {set sobel_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $sobel_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net PixelClk_Generator_clk_out1 [get_bd_pins DVIClocking_0/PixelClk] [get_bd_pins gauss_0/pixel_clk] [get_bd_pins grayscale2rgb_0/pixel_clk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins rgb2grayscale_0/pixel_clk] [get_bd_pins rst_vid_clk_dyn/slowest_sync_clk] [get_bd_pins sobel_0/pixel_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins vtg/clk]
  ...
  connect_bd_net -net gauss_0_data_out [get_bd_pins gauss_0/data_out] [get_bd_pins sobel_0/data_in]
  connect_bd_net -net gauss_0_vid_av [get_bd_pins gauss_0/vid_av] [get_bd_pins sobel_0/vid_active_video]
  connect_bd_net -net gauss_0_vid_pHsync [get_bd_pins gauss_0/vid_pHsync] [get_bd_pins sobel_0/vid_hsync]
  connect_bd_net -net gauss_0_vid_pVsync [get_bd_pins gauss_0/vid_pVsync] [get_bd_pins sobel_0/vid_vsync]
  ...
  connect_bd_net -net grayscale2rgb_0_vsync_out [get_bd_pins grayscale2rgb_0/vsync_out] [get_bd_pins rgb2dvi_0/vid_pVSync]
  ...
  connect_bd_net -net rgb2grayscale_0_data_out [get_bd_pins gauss_0/data_in] [get_bd_pins rgb2grayscale_0/data_out]
  connect_bd_net -net rgb2grayscale_0_vid_VDE [get_bd_pins gauss_0/vid_active_video] [get_bd_pins rgb2grayscale_0/vid_VDE]
  connect_bd_net -net rgb2grayscale_0_vid_pHsync [get_bd_pins gauss_0/vid_hsync] [get_bd_pins rgb2grayscale_0/vid_pHsync]
  connect_bd_net -net rgb2grayscale_0_vid_pVsync [get_bd_pins gauss_0/vid_vsync] [get_bd_pins rgb2grayscale_0/vid_pVsync]
  ...
  connect_bd_net -net sobel_0_sobel_abs [get_bd_pins grayscale2rgb_0/gray_value] [get_bd_pins sobel_0/sobel_abs]
  connect_bd_net -net sobel_0_vid_av [get_bd_pins grayscale2rgb_0/av] [get_bd_pins sobel_0/vid_av]
  connect_bd_net -net sobel_0_vid_pHsync [get_bd_pins grayscale2rgb_0/hsync] [get_bd_pins sobel_0/vid_pHsync]
  connect_bd_net -net sobel_0_vid_pVsync [get_bd_pins grayscale2rgb_0/vsync] [get_bd_pins sobel_0/vid_pVsync]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins rgb2grayscale_0/vid_hsync] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins rgb2grayscale_0/vid_vsync] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
